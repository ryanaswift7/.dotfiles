...
* SYMLINKS
When opening a file symlinked elsewhere, Emacs will always ask if you would like to follow the symlink to edit the original file (especially if it's under VC). This tells Emacs to always do this and never ask me about it.
#+begin_src emacs-lisp
