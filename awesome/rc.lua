...
globalkeys = gears.table.join(
	...
	awful.key({ "Mod3" }, "b", function()
		awful.spawn("zsh -c 'wezterm -e -- btop'")
	...
	awful.key({ modkey }, "F1", function()
		awful.spawn(browser .. " https://f1tv.formula1.com")
	end, { description = "open f1 tv", group = "applications" }),
	...
	end, { description = "lock the screen", group = "system" }),
...
awful.rules.rules = {
	...
	-- Add YouTube fix
	{ rule = { instance = "polybar" }, properties = { below = true, border_width = false } },
...
-- Ensure any floating window is on top
